    ...
    <div class="container pb-5" style="max-width: 900px;">
            ...
            <section>
                ...
                <div class="d-flex flex-wrap gap-2">
                    @foreach ($seccion['tecnologias'] as $tecnologia)
                        <span
                            class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-25 px-4 py-2 fs-6 rounded-pill shadow-sm">
        ...
        <div class="text-center">
            <a href="{{ route('estudiante.test') }}"
                class="btn btn-verde-uth btn-lg px-5 py-3 rounded-pill fw-bold shadow-sm transition-hover">
