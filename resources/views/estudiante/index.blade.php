                ...
                <div class="card-body d-flex flex-column flex-md-row align-items-center justify-content-between p-4 gap-4">
                    <div class="text-center text-md-start">
                        ...
                        <p class="text-dark fw-medium mb-4" style="font-size: 1.1rem;">
                            Realiza nuestro Test Vocacional. Analizaremos tus habilidades, lógica de programación y
                            preferencias para sugerirte la especialidad ideal para ti.
                        </p>
                        @if ($intentos < 2)
                            <a href="{{ route('estudiante.test') }}"
                                class="btn btn-verde-uth fw-bold px-4 py-3 rounded-pill d-inline-flex align-items-center gap-2 text-decoration-none shadow-sm transition-hover fs-5">
                        ...
                        @else
                            <div class="d-flex flex-wrap align-items-center gap-4">
                                ...
                                <a href="{{ route('estudiante.ver_resultados') }}"
                                    class="btn btn-verde-uth fw-bold px-4 py-3 rounded-pill d-inline-flex align-items-center gap-2 text-decoration-none shadow-sm transition-hover fs-5">
                                    <i class="bi bi-pie-chart-fill"></i> VISUALIZA TUS RESULTADOS!
                                </a>
                            </div>
                        @endif
                    </div>
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-lg-4">
            <div class="card tarjeta-especialidad shadow-sm h-100">
                ...
                <div class="card-body p-4 d-flex flex-column">
                    <p class="text-secondary mb-4">Conviértete en un experto creando aplicaciones web, móviles y sistemas de
                        escritorio dominando lenguajes de programación y bases de datos.</p>
                    <a href="{{route('estudiante.infoDesarrollo')}}"
                        class="btn btn-outline-success fw-bold mt-auto rounded-3">Leer más <i
        ...
        <div class="col-lg-4">
            <div class="card tarjeta-especialidad shadow-sm h-100">
                ...
                <div class="card-body p-4 d-flex flex-column">
                    <p class="text-secondary mb-4">Aprende a diseñar experiencias inmersivas, modelado 3D, desarrollo de
                        videojuegos y estrategias de negocios digitales vanguardistas.</p>
                    <a href="{{route('estudiante.infoEntornos')}}"
                        class="btn btn-outline-success fw-bold mt-auto rounded-3">Leer más <i
                            class="bi bi-arrow-right ms-1"></i></a>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card tarjeta-especialidad shadow-sm h-100">
                ...
                <div class="card-body p-4 d-flex flex-column">
                    <p class="text-secondary mb-4">Protege la información de las organizaciones, configura servidores y
                        diseña infraestructuras de telecomunicaciones de alto nivel.</p>
                    <a href="{{route('estudiante.infoRedes')}}"
                        class="btn btn-outline-success fw-bold mt-auto rounded-3">Leer más <i
                            class="bi bi-arrow-right ms-1"></i></a>
                </div>
            </div>
